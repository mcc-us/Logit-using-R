...
1. This report and my article Introduction to Logit^[https://github.com/mcc-us/intro-2-logit/blob/main/intro-2-logit.pdf] discuss my details on logistic regression and R. 
...
### Seven Factors and Their Odds Of Developing Cardiovascular Disease
...
Odds are calculated by using dividing two probabilities. In the case of a *Risk of Stroke.* We would divide the Probability *WITH* the prevalence of stroke in patients' family history *VERSUS* the Probability of *WITHOUT* having the prevalence of stroke in the family history.
